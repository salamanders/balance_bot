...
class TestAgentStartup(unittest.TestCase):
    ...
    def test_recovery_manager_initialized_with_config(self: Any) -> None:
    ...
    def test_normal_run_on_back_triggers_kickup(self: Any) -> None:
        # Arrange
    ...
    def test_normal_run_upright_skips_kickup(self: Any) -> None:
        # Arrange
