...
def run_benchmark() -> None:
    ...
    print(f"Baseline (Blocking): {baseline_time:.2f} ms for {iterations} calls ({baseline_time/iterations:.4f} ms/call)")
    ...
    print(f"Optimized (Throttled): {optimized_time:.2f} ms for {iterations} calls ({optimized_time/iterations:.4f} ms/call)")
