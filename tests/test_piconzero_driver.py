...
class TestPiconZeroDriver(unittest.TestCase):
    ...
    def test_set_motors_calls_individual_writes(self: Any, mock_smbus_cls: Any) -> None:
        """
    ...
    @patch('balance_bot.hardware.piconzero.smbus.SMBus')
    def test_bus_switching(self: Any, mock_smbus_cls: Any) -> None:
    ...
    @patch('balance_bot.hardware.piconzero.smbus.SMBus')
    def test_set_retries(self: Any, _mock_smbus_cls: Any) -> None:
