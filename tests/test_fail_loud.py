...
class TestFailLoud:
    ...
    @pytest.fixture
    def mock_hardware_deps(self: Any) -> Any:
    ...
    def test_set_motors_raises_if_unmapped(self: Any, mock_hardware_deps: Any) -> None:
    ...
    def test_set_motors_raises_if_one_unmapped(self: Any, mock_hardware_deps: Any) -> None:
    ...
    def test_set_motors_succeeds_if_mapped(self: Any, mock_hardware_deps: Any) -> None:
    ...
    def test_read_imu_converted_handles_missing_yaw_in_adult_mode(self: Any, mock_hardware_deps: Any) -> None:
        """
    ...
    def test_read_imu_converted_toddler_mode_safe(self: Any, mock_hardware_deps: Any) -> None:
        """
    ...
    def test_discovery_step_bootstrap(self: Any) -> None:
