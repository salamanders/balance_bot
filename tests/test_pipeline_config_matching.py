...
def test_proprioceptive_toddler_step(monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr(step, "_derive_kinematics_and_polarity", lambda hw, rec, test_pwm, label: ({
    ...
    monkeypatch.setattr(step, "_run_symmetric_rock_and_check", lambda hw, rec, start_pwm, step, label: (20.0, -25.0))
